          ...
          <div>
            ...
            <p>
              ...
              <Link
                ...
                href="https://tuanitpro.com/thiet-ke-website-da-lat"
                rel="tooltip"
              >
                thiết kế trang web
              </Link>
              ...
              <Link
                title="ASP.NET"
                href="https://tuanitpro.com/category/asp-net"
              >
                ASP.NET
              </Link>
              , Java, NodeJS
            ...
            <p>
              ...
              <Link href="http://cv.tuanitpro.com/">Nhiều hơn về tôi?</Link>
            </p>
            ...
            <p>
              ...
              <Link
                ...
                href="https://facebook.com/tuanitpro"
                target="_blank"
                rel="tooltip noopener noreferrer"
              >
              ...
              <Link
                ...
                href="https://www.linkedin.com/in/tuanitpro/"
                target="_blank"
                rel="tooltip noopener noreferrer"
              >
            ...
            <Link title="Liên hệ" href="/contact" rel="tooltip">
              Liên hệ
            </Link>
            &nbsp;với tôi qua email:&nbsp;
            <IonIcon name="mail" />
